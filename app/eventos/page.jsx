  ...
  return (
      <ReactLenis root options={{ lerp: 0.1 }}>
        <div className="h-screen relative">
          <h1 
          className="text-md md:text-base lg:text-lg header-page"
          >
            EVENTOS
          </h1>
          ...
          <img 
            ...
            src="./images/grafitti-event.png" 
          />

          <div className="flex flex-row w-11/12 h-2/3 absolute " style={{ left: "40rem", top: "20rem"}}>
            <EventSelector onPress={changeEvent}/>
          </div>
          <h1 className="text-sm md:text-base lg:text-lg text-gray-400 absolute bottom-20 left-5 secondary-header">
            {data[name].name}
          </h1>
        </div>

        <div className="min-h-screen relative">
          <div className="flex flex-row w-12/12 h-2/3 absolute top-38 right-0 justify-between pr-5">
            <div className="w-12/12 object-cover ">
